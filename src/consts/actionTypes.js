...
export const SEARCH_MOVIE_BY_YEAR_START ='SEARCH_MOVIE_BY_YEAR_START';
export const SEARCH_MOVIE_BY_YEAR_ERROR ='SEARCH_MOVIE_BY_YEAR_ERROR';
export const SEARCH_MOVIE_BY_YEAR_COMPLETE ='SEARCH_MOVIE_BY_YEAR_COMPLETE';